...
import { Dropdown, DropdownContent, DropdownItem, DropdownTrigger } from "@govtechmy/myds-react/dropdown";
    ...
    <Dropdown open={isOpen} onOpenChange={setIsOpen}>
      <DropdownTrigger asChild>
        ...
        >
          ...
          <span className="font-medium text-gray-700">{localeNames[currentLocale]}</span>
      ...
      <DropdownContent align="end" className="w-40">
        {Object.entries(localeNames).map(([locale]) => (
          <DropdownItem key={locale} asChild>
            ...
            >
              <span className="text-gray-700">{localeFullNames[locale as Locale]}</span>
