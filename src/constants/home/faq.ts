export const faq = [
  {
    question: '1. Apakah itu aplikasi MyGOV Malaysia (MyGOV)?',
    answers: `MyGOV adalah aplikasi mudah alih bersepadu bagi perkhidmatan kerajaan yang menawarkan kemudahan capaian perkhidmatan secara mobile bagi memenuhi keperluan rakyat, penjawat awam dan perniagaan.

*Ciri baharu akan datang*`,
  },
  {
    question: '2. Siapakah yang boleh menggunakan MyGOV?',
  ...
  {
    question: '4. Bagaimanakah cara untuk saya memuat turun aplikasi MyGOV?',
...
Samsung Galaxy S22 dengan Android 12
Google Pixel 6 dengan Android 12
Xiaomi 12x dengan Android 12

Semakan versi sistem operasi pada peranti Android:

Langkah 1 - Buka Tetapan (Setting) pada peranti
Langkah 2 - Cari dan tap pada Perihal Telefon (About Phone) > Versi Android (Android Version)

Peranti iPhone: Memerlukan iOS 13 atau versi lebih baharu. Contoh peranti yang serasi termasuk:

iPhone 11 dengan iOS 13
iPhone 12 dengan iOS 14

Semakan versi sistem operasi pada peranti iOS:

Langkah 1 - Buka Tetapan (Setting) pada peranti
Langkah 2 - Cari dan tap pada Umum (General) > Perihal (About)
...
Kebajikan seperti Semakan Mangsa Bencana dan sebagainya
Persaraan iaitu perkhidmatan-perkhidmatan kepada pesara kerajaan dan sebagainya
Pendidikan seperti Semakan Keputusan Peperiksaan Utama Malaysia dan sebagainya
Urusan Tanah seperti Semakan Harta Tanah Persekutuan , dan sebagainya
Berita dan Hebahan
Lain-lain perkhidmatan

Anda boleh melakukan semakan, paparan notifikasi / info / tinjauan, permohonan* dan pembayaran*.
...
Pejabat Tanah dan Galian Persekutuan (PTG)
...
Aplikasi MyGOV hanya berfungsi sebagai platform yang menghubungkan pengguna dengan perkhidmatan-perkhidmatan digital agensi kerajaan dan tidak menyimpan sebarang data pengguna.`,
  ...
  {
    question: '11. Apakah jenis notifikasi yang akan saya terima?',
    answers: `Anda akan menerima tiga jenis notifikasi:

Amaran – Notifikasi daripada NADMA berkaitan banjir, hujan lebat, atau bencana lain dalam masa nyata.
Umum – Makluman daripada kementerian kepada rakyat, seperti informasi, pemberitahuan program kerajaan, saringan kesihatan, dan lain-lain.
Peribadi – Notifikasi khas seperti ucapan hari lahir dan peringatan penting berkaitan akaun atau perkhidmatan yang digunakan.`,
  },
  {
    question: '12. Apakah fungsi bahagian "Berita" dalam aplikasi ini?',
...
3. Cari aplikasi MyGOV, kemudian hentikan notifikasi mengikut pilihan anda.

*Kaedah mungkin berbeza mengikut peranti`,
  },
  {
    question: '14. Mengapa maklumat profil saya tidak tepat?',
  ...
  {
    question:
      '16. Saluran manakah yang patut dihubungi jika saya mempunyai pertanyaan lanjut tentang perkhidmatan dalam aplikasi ini?',
    answers: `Anda boleh menghubungi Pusat Panggilan Kerajaan Malaysia atau Malaysia Government Call Centre (MyGCC) di talian 03-8000 8000.`,
  },
  {
    question:
      '17. Bagaimanakah saya boleh mendapatkan bantuan teknikal sekiranya menghadapi masalah semasa menggunakan aplikasi ini?',
    answers: `Anda boleh mendapatkan bantuan dan membuat aduan di sini. Maklum balas aduan akan diberikan dalam tempoh 3 hari bekerja.`,
  },
  {
    question:
      '18. Bagaimanakah saya boleh mendapatkan bantuan sekiranya menghadapi masalah login semasa mendaftar masuk?',
